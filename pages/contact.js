...
export default function Contact(){
  return (
    <Layout>
      <Head>
        <title>Contact – Alice Artisanal Soap</title>
        <meta name="description" content="Get in touch for wholesale, collaborations or queries."/>
        <meta property="og:title" content="Contact – Alice Artisanal Soap"/>
        <meta property="og:description" content="Get in touch for wholesale, collaborations or queries."/>
